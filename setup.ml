...
(* OASIS_START *)
(* DO NOT EDIT (digest: c80551fca9906c0160802af90d43a7ee) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://mmottl.github.io/cfg";
          bugreports = None;
          synopsis = "CFG - Library for Manipulating Context-Free Grammars";
          description =
            Some
              [
                 OASISText.Para
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "cfg"];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "ocamldoc";
                   ...
                   {exec_custom = false; exec_main_is = "bnf.ml"});
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for CFG";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/mmottl/cfg.git";
                      src_repo_browser = Some "http://github.com/mmottl/cfg";
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\204\204\219\233\147\250I\136\b\217\196%\151J\163\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
