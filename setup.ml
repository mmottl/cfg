...
(* OASIS_START *)
(* DO NOT EDIT (digest: f4bf8c1245446caaed2adec87f6f2416) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://bitbucket.org/mmottl/cfg";
            ...
            [
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Hg;
                      src_repo_location = "ssh://hg@bitbucket.org/mmottl/cfg";
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/cfg";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Æ6z»\135\158v\142ªcE\158\128\1441’";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
